...
export class WishListComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.wishListService
      ...
      .subscribe(
        (res: HttpResponse<IWishList[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInWishLists(): void {
    this.eventSubscriber = this.eventManager.subscribe('wishListListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWishList[] | null, headers: HttpHeaders, page: number): void {
