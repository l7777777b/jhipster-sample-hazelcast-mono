package com.mycompany.hazelcastmono.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterSampleHazelcastMono");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterSampleHazelcastMono");
        ...
        config.getMapConfigs().put("com.mycompany.hazelcastmono.domain.*", initializeDomainMapConfig(jHipsterProperties));
